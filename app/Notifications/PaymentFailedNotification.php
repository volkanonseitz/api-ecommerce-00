...
class PaymentFailedNotification extends Notification implements ShouldQueue
{
    ...
    {
        // Asumsi ada kolom 'language' di model Order, atau menggunakan default
        // Jika Anda tidak menggunakan App::setLocale, hapus baris ini
        ...
        return (new MailMessage)
            ->subject(__('payment.failed_subject', ['ORDER_TRACKING_NUMBER' => $this->order->tracking_number]))
            ->markdown(
