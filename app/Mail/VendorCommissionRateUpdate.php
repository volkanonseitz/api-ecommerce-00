...
class VendorCommissionRateUpdate extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: __('commission.vendor_update_subject', ['SHOP_NAME' => $this->shop->name]),
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.vendor-commission-rate-update',
            with: [
